...
class FashionNet:
    @staticmethod
    def build_category_branch(inputs, num_categories, final_act="softmax", chan_dim=-1):
    ...
    @staticmethod
    def build_color_branch(inputs, num_colors, final_act="softmax", chan_dim=-1):
        # CONV => RELU => POOL
    ...
    def build(width, height, num_categories, num_colors, final_act="softmax"):
        ...
        category_branch = FashionNet.build_category_branch(inputs,
                                                           num_categories, final_act=final_act, chan_dim=chan_dim)
